...
@pytest.mark.parametrize(
    "rho,xys",
    [
        pytest.param(0, [[0, 0], [1, 1], [2, 2]], id="rho=0"),
        pytest.param(0.5, [[0, 0], [1, 1], [2, 2]], id="rho=0.5"),
        pytest.param(-0.615145406302, [[1, 2], [2, 3], [3, 4]], id="rho=-0.6151"),
        pytest.param(0.1, [[1, 2], [2, 3], [3, 4]], id="rho=0.1"),
        pytest.param(0.99, [[1, 2], [2, 3], [3, 4]], id="rho=0.99"),
        pytest.param(-0.86, [[1, 2], [2, 3], [3, 4]], id="rho=-0.86"),
        pytest.param(-0.99, [[1, 2], [2, 3], [3, 4]], id="rho=-0.99"),
        pytest.param(0.3, [[1, 2], [2, 3], [3, 4]], id="rho=0.3"),
        pytest.param(0.3, [[1, np.inf], [2, np.inf], [3, np.inf]], id="y=inf"),
    ],
)
